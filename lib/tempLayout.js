...
function createLayout(graph, physicsSettings) {
    ...
    var api = {
        ...
        getNodePosition: function (nodeId) {
            ...
            var z = layer * interLayerDistance;
            body.pos = new prims.Vector3d(body.pos.x, body.pos.y, z);
            return body.pos;
        },
    ...
    function listenToEvents() {
        ...
        physicsSimulators[1].on('stable', onStableChanged); //TODO: This is just a quick fix
    }
