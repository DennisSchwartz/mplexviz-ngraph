...
var MenuPanel = Backbone.View.extend({
   events: {
    ...
    render: function() {
        ...
        this.el.innerHTML += '<div class="col-md-10"><form class="form-horizontal" id="options">' +
            '<label for="nodesize">Nodesize</label><input type="text" id="nodesize" value="7">' +
            '<label for="linklength">Link length</label><input type="text" id="linklength" value="20">' +
            '<label for="gravity">Node gravity</label><input type="text" id="gravity" value="-1.2">' +
            '<label for="interlayerdist">Layer distance</label><input type="text" id="interlayerdist" value="100">' +
            '<button type="submit" form="options">Update</button>' +
            '</form></div>';
        this.el.innerHTML += '<div class="col-md-2"><input id="fileUpload" type="file"><button id="stop">Stop rendering</button></div>';
    },
