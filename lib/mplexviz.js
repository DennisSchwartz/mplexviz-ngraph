...
var Mplexviz = Backbone.View.extend({
    ...
    createModel: function (upload) {
        ...
        // Create elements list for Tamas API
        var elements = this.network;
        //this.network.get('nodes').each(pushEL);
        //this.network.get('edges').each(pushEL);
        //this.network.get('layers').each(pushEL);
        //this.network.get('V').each(pushEL);
        //
        //console.log("hello!: ");
