...
var MenuPanel = Backbone.View.extend({
    ...
    render: function() {
        ...
        this.el.innerHTML += '<div class="container-fluid">' +
            ...
            '<input type="text" class="form-control margin" id="linklength" value="100">' +
            '</div>' +
            '<div class="form-group">' +
            '<label class="small" for="gravity">Node gravity</label>' +
            '<input type="text" class="form-control input-sm margin" id="gravity" value="-1.05">' +
            '</div>' +
            '<div class="form-group">' +
            ...
            '<input type="text" class="form-control margin" id="planesize" value="300">' +
            '</div>' +
            '<div class="checkbox">' +
            '<label class="small">' +
            '<input type="checkbox" id="planes" checked> show planes' +
            '</label>' +
            '</div>' +
            '<button type="submit" class="btn btn-sm btn-success margin" form="options">Update</button><button class="btn btn-sm btn-info margin" id="reset">Reset</button><button class="btn btn-sm btn-danger margin" id="stop">Stop</button>' +
            '</form></div>' +
            '</div>' +
            '</div>';
    },
    ...
    reset: function () {
        this.eventAggregator.trigger('graph:reset');
    },
    stop: function () {
