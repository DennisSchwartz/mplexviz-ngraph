...
var InfoPanel = Backbone.View.extend({
    ...
    buildInfo: function () {
        ...
        //var type = this.type || '';
        //var label = this.name || '';
        //var source = this.active.get('source') !== 'undefined' ? this.active.get('source') : '';
        //var target = this.active.get('target') !== 'undefined' ? this.active.get('target') : '';
        //var weight = this.active.get('weight') !== 'undefined' ? this.active.get('weight') : '';
        //var directed = this.active.get('directed') !== 'undefined' ? '( ' + this.active.get('directed') + ' )': '';
        //    return  '<p>' +
        //        'Type: ' + type + " " + directed + '<br>' +
        //        'Label: ' + label + '<br>' +
