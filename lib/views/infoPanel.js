...
var InfoPanel = Backbone.View.extend({
    ...
    buildInfo: function () {
        if (this.type === 'Edge') {
            var weight = this.active.data['weight'] ? this.active.data['weight'] : 'N/A';
            return  '<p>' +
                'Type: ' + this.type + '<br>' +
                'Label: ' + this.name + '<br>' +
                'Source:' + this.active.data['source'] + '<br>' +
                'Target:' + this.active.data['target'] + '<br>' +
                'Weight: ' + weight +
                '</p>'
        } else if (this.type === 'Node') {
            return  '<p>' +
                        'Type: ' + this.type + '<br>' +
                        'Label: ' + this.name + '<br><br><br>' +
                        'Layer: ' + this.active.data['layer'] + '<br>' +
                    '</p>';
        } else {
            return  '<p>' +
