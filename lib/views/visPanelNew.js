...
var fixedLayout = require('../layout/FixedMultilayer');
...
var VisPanelNew = Backbone.View.extend({
    ...
    initialize: function (opts) {
        ...
        this.layout = opts.layout || fixedLayout(this.graph);//mplexLayout(this.graph);
        this.settings = {
            nodesize: 7,
    ...
    renderGraph: function () {
        ...
        var graphics = Graphics(this.graph, this.layout, {
            library: 'three',
            container: this.el,
            interactive: true
        });
