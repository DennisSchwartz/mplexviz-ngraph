...
var VisPanelNew = Backbone.View.extend({
    ...
    initialize: function (opts) {
        ...
        /**
         * TODO: This needs an update to use without ngraph.graph!!
         */
        var g = this.tempGraph(this.graph);
        this.layout = mplexLayout(g);
    ...
    renderGraph: function () {
        ...
        var graphics = Graphics(this.graph, this.layout, { library: 'three' });
        ...
        this.applySettings(graphics, this.settings, function (graphics) {
            graphics.run();
            console.log(graphics.library.lib.scene);
        });
    ...
    applySettings: function (graphics, settings, callback) {
        ...
        graphics.setNodeUI(function (node) {
            ...
            var nodeGeometry = new THREE.BoxGeometry(5, 5, 5);
